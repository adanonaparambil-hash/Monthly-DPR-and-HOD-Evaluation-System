  ...
  animations: [
    ...
    trigger('scaleIn', [
      transition(':enter', [
        ...
        animate('0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94)', style({ transform: 'scale(1)', opacity: 1 }))
      ])
    ]),
    trigger('slideInLeft', [
      transition(':enter', [
...
export class CedDashboard implements OnInit, AfterViewInit {
  ...
  // Top Performers
  topPerformers = [
    { name: 'Sarah Johnson', department: 'Engineering', score: 96, avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=60&h=60&fit=crop&crop=face&auto=format' },
    { name: 'Michael Chen', department: 'Sales', score: 94, avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=60&h=60&fit=crop&crop=face&auto=format' },
    { name: 'Emily Davis', department: 'Marketing', score: 92, avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=60&h=60&fit=crop&crop=face&auto=format' },
    { name: 'Robert Taylor', department: 'Engineering', score: 91, avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=60&h=60&fit=crop&crop=face&auto=format' },
    { name: 'Lisa Anderson', department: 'Finance', score: 89, avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=60&h=60&fit=crop&crop=face&auto=format' }
  ];
  ...
  private createHODRadar() {
    ...
    if (ctx) {
      new Chart(ctx, {
        type: 'radar',
        data: {
          labels: ['Quality', 'Timeliness', 'Initiative', 'Communication', 'Leadership', 'Innovation'],
          datasets: [{
